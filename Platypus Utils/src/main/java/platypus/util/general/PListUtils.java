...
public class PListUtils {
	 ...
	 *            the list to sort
	 * @param low
	 *            the bottom index of the partition to be sorted (inclusive)
	 * @param high
	 *            the upper index of the partition to be sorted (inclusive)
	 */
	 ...
	 */
	public static int binSearch(List<Comparable<Object>> list, Comparable<Object> query) {
		// TODO
		return -1;
	}
